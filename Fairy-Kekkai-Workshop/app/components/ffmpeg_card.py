...
class FFmpegItemWidget(CardWidget):
    """下载任务项组件"""
    ...
    def _initUI(self):
        ...
        self.cancelBtn.setVisible(self.task.status == "压制中")
    ...
    def updateStatus(self, status, success=True, error_message=""):
        ...
        self.cancelBtn.setVisible(status == "压制中")
    ...
    def _completeCancellation(self):
        ...
        event_bus.notification_service.show_info(
            "压制已取消", f"任务 '{self.task.video_path}' 已被取消"
        )
