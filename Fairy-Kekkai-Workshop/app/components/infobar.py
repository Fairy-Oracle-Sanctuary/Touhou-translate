...
class NotificationService(QObject):
    ...
    def show_success(self, title: str, content: str, parent: QWidget = None, duration: int = None):
        """显示成功通知"""
        self._show_notification("success", title, content, parent, duration)
    
    def show_error(self, title: str, content: str, parent: QWidget = None, duration: int = None):
        """显示错误通知"""
        self._show_notification("error", title, content, parent, duration or 5000)  # 错误显示5秒
    
    def show_warning(self, title: str, content: str, parent: QWidget = None, duration: int = None):
        """显示警告通知"""
        self._show_notification("warning", title, content, parent, duration)
    
    def show_info(self, title: str, content: str, parent: QWidget = None, duration: int = None):
        """显示信息通知"""
        self._show_notification("info", title, content, parent, duration)
    
    def _show_notification(self, type: str, title: str, content: str, 
                          parent: QWidget = None, duration: int = None):
        """显示通知的内部方法"""
