...
# videocr_cli.py路径
VIDEOCR_CLI_PATH = Path(__file__).parent / "videocr_cli.py"
# 输出目录
OUTPUT_DIR = PROJECT_ROOT / "dist" / "videocr_cli"
...
def run_nuitka():
    """使用nuitka打包videocr_cli.py为单个文件"""
    print("正在使用nuitka打包videocr_cli.py...")
    ...
    args = [
        ...
        "--include-module=uuid",  # videocr需要的模块
