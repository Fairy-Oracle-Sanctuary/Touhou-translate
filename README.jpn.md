...
| 6 | いじめられてる男の子を助ける天使の妹 | 《拯救被欺凌男孩的天使妹妹》 | [YouTubeリンク](https://youtube.com/playlist?list=PLkONYltbNkGdPwu1CVug0NyOROBUShYqh) | [BiliBiliリンク](https://space.bilibili.com/499929312/lists/6809460) |
| 7 | ヴォルガが幻想入り | 《幻想入沃尔加》 | [YouTubeリンク](https://youtube.com/playlist?list=PLn5zMpk5-YR-Qzz5RcosD3oA5MbuMk23V) | [BiliBiliリンク](https://space.bilibili.com/499929312/lists/6525221) |
| 8 | 『好き』という気持ちが行き着く場所 | 《名为喜欢的这份心情终将抵达之所》 | [YouTubeリンク](https://youtube.com/playlist?list=PLkONYltbNkGeSqD-pDcXaWsj7dgJSejz8) | `一時停止中` |
| 9 | 魔法みたいな恋をした | 《谈了一场如魔法般的恋爱》 | [YouTubeリンク](https://youtube.com/playlist?list=PLwnprYHAfPHZ0bKlsSRE1CQYkWNYw5L6U) | [BiliBiliリンク](https://space.bilibili.com/499929312/lists/6702992) |
| 10 | 色付く恋は、貴方から | 《染上色彩的恋爱始于你第一季》 | [YouTubeリンク](https://www.youtube.com/playlist?list=PLwsFUfY3oQWJ3GsyshggcsJbI6_X8hRD0) | `進行中` |
| 11 | 盲目の少女と醜い少年の話 | 《盲眼的少女与丑陋的少年》 | [YouTubeリンク](https://youtube.com/playlist?list=PLuabzLomQRYUsFGKUThPnEMJ-zT2dxdBj) | [BiliBiliリンク](https://space.bilibili.com/499929312/lists/7221002) |
| 12 | 東方MMD（初心者動画） | 《東方MMD（初心者動画）》 | [YouTube链接](https://www.youtube.com/playlist?list=PLAj9cJ2slYo_AJjUvKGFmG-j0lzySK_e8) | [BiliBiliリンク](https://space.bilibili.com/499929312/lists/7120067) |
...
*   **プロジェクト管理:** 各翻訳プロジェクトの進捗、リソース、メタデータを簡単に管理します。
*   **リソースダウンロード:** YouTubeビデオダウンローダー内蔵、プレイリストからの一括取得をサポート。
*   **字幕抽出:** OCR技術を利用して、動画内のハードコードされた字幕テキストを素早く認識・抽出し、SRT字幕ファイルを生成します。
*   **音声認識:** [Const-me/Whisper](https://github.com/Const-me/Whisper)ベースで、多言語の音声を字幕に変換、リアルタイム進捗表示対応（Windowsのみ）。
*   **AI翻訳:** 複数のAIモデル（Deepseek、腾讯混元、ERNIE、Gemini、书生など）に接続し、自動翻訳機能を実現（API Keyは各自で準備が必要）。
*   **動画圧縮:** ffmpeg ツールを組み込み、動画ファイルの圧縮をサポート。
*   **テーマ切り替え:** タイトルバーのショートカットボタンでダーク/ライトモードを切り替え可能。
*   **起動画面:** プログレスバーとステータス表示付きの起動画面。
...
<p>
  <a href="https://space.bilibili.com/109338384" target="_blank">
    <img src="https://i0.hdslb.com/bfs/face/af219ece11c0d2c4fd92cf993cb149dcfb5543d4.jpg@160w_160h_1c_1s.webp" alt="寄遗忘之物于流年" style="border-radius: 50%; width: 65px; height: 65px; display: inline-block; overflow: hidden;" />
  </a>
  <a href="https://space.bilibili.com/3546748681194187" target="_blank">
    <img src="https://i1.hdslb.com/bfs/face/8cb688c437daa011c9b0c4c5d22885fef313a3c0.jpg@160w_160h_1c_1s.webp" alt="兴趣使然的鸽子口牙" style="border-radius: 50%; width: 65px; height: 65px; display: inline-block; overflow: hidden;" />
  </a>
