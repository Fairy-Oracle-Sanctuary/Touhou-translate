...
| 6 | いじめられてる男の子を助ける天使の妹 | 《拯救被欺凌男孩的天使妹妹》 | [YouTube链接](https://youtube.com/playlist?list=PLkONYltbNkGdPwu1CVug0NyOROBUShYqh) | [BiliBili链接](https://space.bilibili.com/499929312/lists/6809460) |
...
| 10 | 色付く恋は、貴方から | 《染上色彩的恋爱始于你第一季》 | [YouTube链接](https://www.youtube.com/playlist?list=PLwsFUfY3oQWJ3GsyshggcsJbI6_X8hRD0) | [BiliBili链接](https://space.bilibili.com/499929312/lists/7221002) |
...
- **语音识别**：基于 [Const-me/Whisper](https://github.com/Const-me/Whisper)，支持多语言语音转字幕，带实时进度显示（仅 Windows）。
- **AI翻译**: 接入多个 AI 模型（Deepseek、腾讯混元、ERNIE、Gemini、书生等），实现自动翻译功能(需自备API Key)。
